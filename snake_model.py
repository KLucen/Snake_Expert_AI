...
def main():
    ...
    def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
        ...
        for epoch in range(num_epochs):
            ...
            if epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model.state_dict(), f'./temp/best_efficientnet_model_epoch_{epoch}.pth')
    ...
    final_model_path = os.path.join(model_dir, "model_snakes.pt")
    ...
    report_save_path = os.path.join(report_dir, "report", "classification_report_on_nvidia_efficientnet.txt")
